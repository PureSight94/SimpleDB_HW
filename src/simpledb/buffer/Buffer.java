...
public class Buffer {
   ...
   void assignToBlock(Block b) {
      ...
      contents.read(blk);
      pins = 0;
      System.out.println("Block Number used: " + b.getBlkNum());
      System.out.println("Num of buffers: " + this.numBuffer);
      //BasicBufferMgr.existingBlock.put(blk.getBlkNum(), this.numBuffer);
   }
